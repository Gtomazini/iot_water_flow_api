...
from crud.codigo_usuario import codigo_retorno_id_user, create_codigo_usuario, get_codigo_usuario, \
    deletar_codigo_usuario
...
@router.post("/codigo-usuario", response_model=CodigoUsuarioModel, status_code=201)
